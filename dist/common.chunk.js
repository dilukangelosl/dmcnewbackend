...
var TaskService = /** @class */ (function () {
    function TaskService(router, afDB) {
        this.router = router;
        this.afDB = afDB;
    ...
    TaskService.prototype.getGodsallTasks = function () {
        return this.afDB.list("/disaster/");
    };
    TaskService.prototype.closeTask = function (taskId, message) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var i = _this.afDB.object('/disaster/' + taskId);
            i.update({ status: "Closed", responseMessage: message, statusdetails: "Closed on " + __WEBPACK_IMPORTED_MODULE_3_moment__().toString() }).then(function (res) {
                resolve(true);
            }).catch(function (err) {
                reject(err);
            });
    ...
    TaskService.prototype.getAllCompletedTasks = function (tasks) {
        return tasks.filter(function (task) { return task.status === "Closed"; });
    };
    TaskService.prototype.getAllPendingTasks = function (tasks) {
        return tasks.filter(function (task) { return task.status === "Pending"; });
    };
    TaskService.prototype.getTask = function (id) {
        return this.afDB.object('disaster/' + id);
    };
    TaskService.prototype.getVictimDetails = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.afDB.object('users/' + id).subscribe(function (res) {
                resolve(res);
            });
        });
    };
    TaskService.prototype.getChat = function (taskid) {

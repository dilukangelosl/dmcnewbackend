...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ng_gallery__ = __webpack_require__("../../../../ng-gallery/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_14_ng_gallery__["a" /* GalleryModule */].forRoot(galleryConfig),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_auth_auth_service__ = __webpack_require__("../../../../../src/app/shared/services/auth/auth.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__services_auth_auth_service__["a" /* AuthService */]]
        }),
...
module.exports = "<nav class=\"sidebar\" [ngClass]=\"{sidebarPushRight: isActive}\">\n    <ul class=\"list-group\">\n        <a routerLink=\"/dashboard\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-fw fa-dashboard\"></i>&nbsp;{{ 'Dashboard' | translate }}\n        </a>\n\n        <a routerLink=\"/godsview\" [routerLinkActive]=\"['router-link-active']\" class=\"list-group-item\">\n            <i class=\"fa fa-fw fa-dashboard\"></i> Gods View\n        </a>\n       \n       \n        \n       \n       \n    </ul>\n</nav>\n"
...
var AuthService = /** @class */ (function () {
    function AuthService(af, router, afDB) {
        this.af = af;
        this.router = router;
        this.afDB = afDB;
    }
    AuthService.prototype.login = function (email, password) {
        ...
        return new Promise(function (resolve, reject) {
            _this.af.auth.signInWithEmailAndPassword(email, password).then((function (res) {
                //console.log(res);
                var item = _this.getuserdetails(res.uid);
                item.subscribe(function (agent) {
    ...
    AuthService.prototype.getuserdetails = function (uid) {
        return this.afDB.object("/agents/" + uid);
    };
    AuthService.prototype.logout = function () {
        var uid = this.getuseruid();
        var item = this.getuserdetails(uid);
        item.update({ status: "offline" });
        this.setLogginSession(false);
        this.af.auth.signOut();
        this.router.navigate(['./login']);
    };
    AuthService.prototype.setLogginSession = function (state) {
        if (state) {
    ...
    AuthService.prototype.getuseruid = function () {
